  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route path="/users" element={<ProtectedRoute permission="USER_READ"><ComingSoon /></ProtectedRoute>} />
        <Route path="/roles" element={<ProtectedRoute permission="ROLE_READ"><ComingSoon /></ProtectedRoute>} />
